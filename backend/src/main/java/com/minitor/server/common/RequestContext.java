...
public final class RequestContext {
    ...
    public static final String H_FRESHNESS = "X-Minitor-Freshness";
    public static final String H_PARTIAL = "X-Minitor-partial";
    public static final String H_GRAIN = "X-Minitor-Grain";
    public static final String H_DICT_VERSION = "X-Minitor-Dict-Version";
    ...
    public static class ContextFilter extends OncePerRequestFilter {
        ...
        public ContextFilter(org.springframework.core.env.Environment env) {
            this.dictVersion = env.getProperty("minitor.dict-version", "2026.09");
        }
