...
import com.minitor.server.service.DashboardService;
...
public class DashboardController {
    ...
    public DashboardController(DashboardService dashboard, MinitorProperties props) {
    ...
    public ApiResponse<List<MinitorStore.CityRow>> cityRank(
            @RequestParam(name = "biz_line", required = false) String bizLine,
            @RequestParam(required = false) String from,
            @RequestParam(required = false) String to,
