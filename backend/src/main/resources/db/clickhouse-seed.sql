...
(event_id, event_type, event_time, ingest_time, order_id, trip_id, city_id, seat_type, biz_line, driver_id_hash, amount, props, version) VALUES
    ('CS-DEMO-01', 'prepay_succeeded',     toDateTime64(concat(toString(yesterday()), ' 09:12:08'), 3, 'Asia/Shanghai'),   now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 8650, '{"pay_channel":"wx","note":"¥86.50 · 杭州市"}', 1),
    ('CS-DEMO-02', 'order_pool_entered',   toDateTime64(concat(toString(yesterday()), ' 09:13:41'), 3, 'Asia/Shanghai'),  now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 0,    '{"passenger_estimate":2,"note":"独享 · 预计 2 人"}', 1),
    ('CS-DEMO-03', 'order_grab_submitted', toDateTime64(concat(toString(yesterday()), ' 09:16:20'), 3, 'Asia/Shanghai'),  now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 0,    '{"candidate_drivers":8,"note":"候选司机 8"}', 1),
    ('CS-DEMO-04', 'order_grab_won',       toDateTime64(concat(toString(yesterday()), ' 09:16:22'), 3, 'Asia/Shanghai'),  now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 0,    '{"match_cost_ms":2100,"note":"耗时 2.1s"}', 1),
    ('CS-DEMO-05', 'passenger_confirmed',  toDateTime64(concat(toString(yesterday()), ' 09:18:04'), 3, 'Asia/Shanghai'),   now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 0,    '{"confirm_mode":"manual","note":"手动确认"}', 1),
    ('CS-DEMO-06', 'passenger_boarded',    toDateTime64(concat(toString(yesterday()), ' 10:02:19'), 3, 'Asia/Shanghai'),  now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 0,    '{"wait_sec":261,"note":"等待 4m 21s"}', 1),
    ('CS-DEMO-07', 'order_delivered',      toDateTime64(concat(toString(yesterday()), ' 11:17:52'), 3, 'Asia/Shanghai'), now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 0,    '{"trip_duration_sec":4533,"note":"履约 75m 33s"}', 1),
    ('CS-DEMO-08', 'settlement_credited',  toDateTime64(concat(toString(yesterday()), ' 11:18:14'), 3, 'Asia/Shanghai'), now(), 'CP20260903018462', 'T8842017763', 330100, 'exclusive', 'carpool', '8a7f921de', 7240, '{"note":"司机收入 ¥72.40"}', 1);
